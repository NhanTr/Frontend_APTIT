...
function StudentsList() {
  ...
  return (
    <Card>
      <CardHeader className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <CardTitle className="text-card-foreground">Students Overview</CardTitle>
          <CardDescription>All registered students and their enrollments</CardDescription>
        </div>
          ...
          {mockStudents.map((student) => (
            ...
            >
              ...
              <div className="flex items-center justify-between text-sm">
                <span className="text-muted-foreground">Activities: {student.enrolledActivities.length}</span>
            ...
            <TableBody>
              {mockStudents.map((student) => (
                <TableRow key={student.id}>
                  ...
                  <TableCell className="text-muted-foreground">{student.enrolledActivities.length}</TableCell>
                  <TableCell className="text-muted-foreground">{student.joinDate}</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
...
export function AdminDashboard() {
  ...
  const mockStudents = [
    { id: "s1", name: "Emily Parker", email: "emily.parker@school.edu", grade: "10th" },
    { id: "s2", name: "Liam Johnson", email: "liam.j@school.edu", grade: "11th" },
  ]
    ...
    <div className="flex flex-col gap-4 sm:gap-6">
      ...
      <Tabs defaultValue="approvals" className="w-full">
        <TabsList className="w-full sm:w-auto">
          <TabsTrigger value="approvals" className="flex-1 sm:flex-none">Approvals</TabsTrigger>
